...
const en = {
  ...
  info: {
    ...
    distanceFromPlanet: (parent: string) => `Distance from ${parent}`,
...
const es: Translation = {
  ...
  info: {
    ...
    distanceFromPlanet: (parent) => `Distancia a ${parent}`,
  ...
  moonFacts: {
    ...
    Phobos: 'Orbita más cerca de su planeta que cualquier otra luna — da tres vueltas a Marte cada día, saliendo por el oeste y poniéndose por el este. Marte lo atrae poco a poco: en unos 50 millones de años se romperá y formará un anillo.',
    Deimos: 'Tan pequeño y ligero que un paseo rápido en bicicleta alcanzaría su velocidad de escape — una piedra lanzada con fuerza jamás vuelve a caer. Desde la superficie de Marte parece una estrella brillante que se desplaza lentamente.',
    ...
    Mimas: 'El cráter Herschel ocupa un tercio de su cara y le da el aspecto de la Estrella de la Muerte — el impacto que lo excavó estuvo a punto de destrozar la pequeña luna.',
    ...
    Tethys: 'Hielo de agua casi puro de la superficie al núcleo — un solo cañón, Ithaca Chasma, recorre tres cuartas partes de su contorno.',
    Dione: 'Las vetas brillantes de su cara posterior resultaron ser imponentes acantilados de hielo — y los datos de gravedad sugieren un océano enterrado en sus profundidades.',
    Rhea: 'La segunda luna más grande de Saturno, una antigua bola de hielo y roca — y la única luna de la que se ha sospechado que tenga anillos propios.',
    ...
    Iapetus: 'Un mundo de dos caras: un hemisferio oscuro como el carbón y otro brillante como la nieve — con una cordillera que recorre su ecuador como la costura de una nuez.',
